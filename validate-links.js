    ...
    async validateSingleLink(browser, url) {
        ...
        while (attempts < this.retryCount) {
            ...
            try {
                ...
                console.log(`URL: ${url}, Status: ${status}, Content-Type: ${contentType}, Response Time: ${responseTime}ms`);
                ...
                const hasErrorContent = errorPatterns.some(pattern => 
                    pageText.includes(pattern) || titleLower.includes(pattern)
                );

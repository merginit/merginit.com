...
<svelte:head>
	<title>Cookie Policy - MerginIT e.U.</title>
	<meta
		name="description"
				...
				<span>
					<span>
						<span>
							...
							are called "third-party cookies". Third-party cookies enable third-party features or functionality
							to be provided on or through the website (e.g., advertising, interactive content, and analytics).
							The parties that set these third-party cookies can recognize your computer both when it
				...
				<span>
					<span>
						<span>
							...
							for technical reasons in order for our Website to operate, and we refer to these
							...
							Properties.Third parties serve cookies through our Website for advertising, analytics,
				...
				<span>
					<span>
						<span>
							...
							users use the Website. The information gathered does not identify any individual
							visitor. The information is aggregated and therefore anonymous. It includes the number
							of visitors to our Website, the websites that referred them to our Website, the pages
							they visited on our Website, what time of day they visited our Website, whether they
							have visited our Website before, and other similar information. We use this
							information to help operate our Website more efficiently, to gather broad demographic
							...
							<table>
								<tbody>
									...
									<tr>
										...
										<td>
											<span
												>Identifies the first time a user has visited the website. This allows for
												the identification of new users.</span
											>
										</td>
									</tr>
									<tr>
							...
							<table>
								<tbody>
									...
									<tr>
										...
										<td>
											<span
												>Used widely by Microsoft as a unique user ID. It enables user tracking by
												synchronizing the ID across many Microsoft domains.</span
											>
										</td>
									</tr>
									<tr>
					...
					<span>
						<span>
							<span>
								...
								called"tracking pixels"or"clear gifs"). These are tiny graphics files that contain a
								unique identifier that enables us to recognize when someone has visited our
								Websiteor opened an email including them. This allows us, for example, to monitor
							</span>
							<span>
								<span>
									<span>
			...
			<div>
				<span>
					<span>
						...
						<span>
							<span>
								this Cookie Policy from time to time in order to reflect, for example, changes to
					...
					<span>
						<span>
							<bdt
								...
								refer to our legal <a href="/legal/imprint">Imprint</a> for contact information.</bdt
							>
						</span>
					</span>
				</span>

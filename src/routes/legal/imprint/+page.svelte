...
<main class="bg-white">
	<article class="container mx-auto prose px-4 py-8">
		...
		<p>
			...
			Datenverarbeitung und IT<br />
			<strong>UID-Nummer:</strong> "Umsatzsteuerbefreit aufgrund der Kleinunternehmerregelung"<br />
			<strong>GISA (Gewerbeinformationssystem Austria):</strong> 38391262<br />
			<strong>Mitglied bei:</strong> Wirtschaftskammer Oberösterreich, FG Unternehmensberatung,
			Buchhaltung und Informationstechnik<br />
			<strong>Berufsrecht:</strong><br />Gewerbeordnung 1994 (GewO)<br />
			E-Commerce-Gesetz (ECG)<br />
			Urheberrechtsgesetz (UrhG)<br />
			Datenschutz-Grundverordnung (DSGVO) und Datenschutzgesetz (DSG)<br />
		...
		<p>
			...
			Rechtsinformationssystem des Bundes unter <a
		...
		<p>
			...
			Österreich<br />
			<strong>E-Mail:</strong> <a href="mailto:jonas@merginit.com">jonas@merginit.com</a>
			<br />
			<strong>Tel.:</strong> +43 6643279885<br />
		...
		<p>
			...
			<a href="https://taeglichfrischesobst.com" target="_blank" rel="noopener"
				>https://taeglichfrischesobst.com</a
			>
			<br />
		...
		<p>
			<strong>E-Mail:</strong> <a href="mailto:jonas@merginit.com">jonas@merginit.com</a>
			<br />
			<strong>Telefonnummer der Kontaktstelle:</strong> +43 6643279885<br />
			<strong>Sprachen der Kontaktstelle:</strong> Deutsch (Muttersprache), Englisch (fließend)<br
			/>
